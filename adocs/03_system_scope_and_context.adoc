...
image:https://raw.githubusercontent.com/Arquisoft/dechat_es6a2/master/docs/images/Business%20Context.png[Business Context,800]

=== Technical Context

**Technical Context diagram**

image:https://raw.githubusercontent.com/Arquisoft/dechat_es6a2/master/docs/images/Technical%20Context.png[Technical Context,800]
