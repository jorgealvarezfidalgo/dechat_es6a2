...
There are unit tests using mocha at
 https://github.com/Arquisoft/dechat_es6a2/tree/master/test[test].
...
There are also some https://cucumber.io/[Cucumber based tests] defined at
 ...
 And finally some https://gatling.io[Gatling performance tests] defined at
  https://github.com/Arquisoft/dechat_es6a2/tree/master/test/performance/user-files/simulations[simulations].
