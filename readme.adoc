...
There are also some https://cucumber.io/[Cucumber based tests] defined at
 ...
 And finally some https://gatling.io[Gatling performance tests] defined at
  https://github.com/Arquisoft/dechat_es6a2/tree/master/performance/gatling/user-files/simulations/computerdatabase[simulations]
  and the https://github.com/Arquisoft/dechat_es6a2/tree/master/performance/gatling/results[results].
