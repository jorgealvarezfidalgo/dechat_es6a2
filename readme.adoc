...
Copia del proyecto en el que tomé parte en la asignatura de ASW del curso 2018-2019, vencedor del Solid Chat Challenge, que conservo aquí por motivos de divulgación histórica.
