...
image:https://coveralls.io/repos/github/Arquisoft/dechat_es6a2/badge.svg?branch=master["Coverage", link="https://coveralls.io/github/Arquisoft/dechat_es6a2?branch=master"]
