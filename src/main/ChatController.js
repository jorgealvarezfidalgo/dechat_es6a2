...
$("#emoji-icon").click(async () => {
    ...
    $('.emojis-menu').append("<img src=' main/resources/static/img/ale.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/angel.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/angry.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/awklaugh.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/broken.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/coffee.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/D.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/dance.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/doubt.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/friend_default.jpg' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/grazy.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/group.jpg' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/icon.png' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/idk.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/jaja.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/jajano.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/jiji.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/lmao.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/n1.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/npc.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/popcorn.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/remove.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/sadpepe.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/sidra.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/sing.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/smugpepe.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/sniper.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/srsly.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/thumbsup.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/wink.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/worship.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/yesyes1.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/yesyes2.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/yesyes3.gif' onclick='writeEmoji(this.src)' />");
    $('.emojis-menu').append("<img src=' main/resources/static/img/youwhat.gif' onclick='writeEmoji(this.src)' />");
});
